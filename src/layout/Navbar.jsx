        ...
        <>
            <div className='flex justify-between w-full items-center h-24 p-4'>
                <h1 className='text-4xl font-bold w-auto hover:cursor-pointer'>REVOOM</h1>
                    ...
                    <button className='text-[20px] hidden custom-lg:block border w-[176px] h-[50px] rounded-[30px] hover:bg-gray-500 hover:bg-opacity-50 hover:ease-in-out duration-[500ms]'>Get In Touch</button>
