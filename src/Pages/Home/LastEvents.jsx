...
const LastEvents = () => {
  ...
  return (
    <div className='my-8 md:px-28'>
        <h1 className='mb-6 text-blue-950 text-4xl font-medium md:px-1 px-5'>Lastest Events</h1>
        <div ref={eventsCards} className='py-10 mx-auto w-full scroll-smooth flex overflow-x-auto px-16 scrollbar-none'>
